...
/*
var minifigure = document.querySelector('.lego-figure');
var faces = document.querySelector('.faces');
...
var expressionRangeInput = document.querySelector('.expression-range');
var colorRangeInput = document.querySelectorAll('.color-range');
var upperHue = document.getElementById('upperbody-hue');
var upperSaturation = document.getElementById('upperbody-saturation');
var upperLightness = document.getElementById('upperbody-brightness');
var lowerHue = document.getElementById('lowerbody-hue');
var lowerSaturation = document.getElementById('lowerbody-saturation');
var lowerLightness = document.getElementById('lowerbody-brightness');
